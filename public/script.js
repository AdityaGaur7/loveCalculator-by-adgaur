...
let cutie = ['gif/l2.gif', 'gif/l3.gif', 'gif/l5.gif', 'gif/l6.gif', 'gif/l10.gif', 'gif/l11.gif', 'gif/l12.gif', 'gif/l13.gif', 'gif/l17.gif'
    ...
    let happysong =['song/dandelion.mp3','song/timropratiksha.mp3','song/youreyes.mp3'];
    let sadsong=['song/moyemoye.mp3','song/hasibngye.mp3','song/tuhaikahan.mp3','song/mix.mp3',];
